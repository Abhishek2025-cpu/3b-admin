...
// --- Reusable Helper Components (Toast component is removed) ---
...
function AddCategoryForm() {
  ...
  const handleSubmit = async (e) => {
    ...
    if (imageFiles.length === 0) {
      toast.error('Please select at least one image.'); // Using react-hot-toast for error
      return;
    }
    ...
    const promise = fetch('https://threebtest.onrender.com/api/categories/add-category', {
      method: 'POST',
      body: data,
    }).then(async (res) => {
      if (!res.ok) {
      ...
      return res.json(); // Return data if success
    });
  ...
  return (
    <div className="bg-gray-100 min-h-screen p-4 sm:p-8">
      ...
      {/* Add Toaster component here to display hot-toasts */}
